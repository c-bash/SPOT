...
%% COPY-PASTED FROM MAIN (OLD ARCHITECTURE)
...
vtar = [0.00;0.00]; % target COM velocity, m/s
thetat0 = pi/4; % rad, initial target angle
thetat_dot = 0.0 * d2r; % rad/s, rotation rate of target spacecraft
