...
%DATA_DATE = ['2022_6_21_16_48','2022_6_21_16_55','2022_6_21_17_14','2022_6_21_14_19','2022_6_21_17_24']; % TEST CASE B, OBST

PRENAME = 'RED_2022_6_21_16_48';
load(strcat(strcat('062122DATA-UPDATED/Saved Data/ExperimentData_',PRENAME),'/MPC_Validation_2_2__stitched.mat'))
...
for i = 1 : length(ani_posx)-1
    ...
    plot(ani_posx(1:i), ani_posy(1:i), 'r.-'); % Plot the solution up until i
    hold on
    plot(ani_ptar(1:i,1), ani_ptar(1:i,2), 'k.-'); % Plot the solution up until i
    hold on
    plot(ani_pobj(1:i,1), ani_pobj(1:i,2), 'b.-'); % Plot the solution up until i
    hold on
    ...
    if i == length(ani_posx)-1
        % last still
        saveas(gcf,strcat(strcat('062122DATA-UPDATED/Saved Data/ExperimentData_',PRENAME),'/finalstill.png'))
